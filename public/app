...
function App() {
  const [activeTab, setActiveTab] = useState<
    "tasks" | "inventory" | "analytics" | "integrations"
  >("tasks");
  ...
  const addService = async () => {
    ...
    const serviceDate =
      prompt("Service Date (YYYY-MM-DD):") ||
      new Date().toISOString().split("T")[0];
  ...
  return (
    ...
    >
      ...
      >
        <h1
          style={{ fontSize: "34px", fontWeight: "700", margin: "0 0 10px 0" }}
        >
          CarLot Manager
        </h1>
      ...
      >
        {(["tasks", "inventory", "analytics", "integrations"] as const).map(
          (tab) => (
            <button
              key={tab}
              ...
              >
                ...
                >
                  ...
                  <select
                    value={task.status}
                    onChange={(e) =>
                      updateTaskStatus(task, e.target.value as Task["status"])
                    }
                    style={{
                      padding: "6px 12px",
                      borderRadius: "6px",
      ...
      {activeTab === "inventory" && (
        <div>
          ...
          <div
            style={{
              display: "grid",
              gridTemplateColumns: selectedVehicle ? "1fr 1fr" : "1fr",
              gap: "20px",
            }}
          >
            <div style={{ display: "grid", gap: "15px" }}>
            ...
            >
              ...
              <div
                style={{
                  fontSize: "28px",
                  fontWeight: "700",
                  color: analytics.profit >= 0 ? "#34C759" : "#FF3B30",
                }}
              >
