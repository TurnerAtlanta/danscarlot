    ...
    <div style={{ padding: "20px" }}>
        ...
        >
          ...
          <span
            style={{
              ...
              fontWeight: "600",
              background:
                status.wayneReeves.status === "connected"
                  ? "#34C759"
                  : "#8E8E93",
              color: "white",
            }}
        ...
        >
          ...
          <span
            style={{
              ...
              fontSize: "12px",
              fontWeight: "600",
              background: status.quickbooks.authenticated
                ? "#34C759"
                : "#8E8E93",
              color: "white",
            }}
        ...
        <div style={{ display: "flex", gap: "10px" }}>
          {!status.quickbooks.authenticated ? (
            <button
              ...
              style={{
                padding: "10px 20px",
                background: status.quickbooks.configured
                  ? "#007AFF"
                  : "#d2d2d7",
                color: "white",
                border: "none",
                borderRadius: "8px",
                cursor: status.quickbooks.configured
                  ? "pointer"
                  : "not-allowed",
                fontSize: "14px",
                fontWeight: "500",
      ...
      >
          ...
          >
            ...
            <div
              style={{
                fontSize: "16px",
                fontWeight: "600",
                color: status.listings.carGurus.configured
                  ? "#34C759"
                  : "#8E8E93",
              }}
            >
              {status.listings.carGurus.configured
                ? "✓ Configured"
                : "Not configured"}
            </div>
          </div>
          ...
          >
            ...
            <div
              style={{
                fontSize: "16px",
                fontWeight: "600",
                color: status.listings.trueCar.configured
                  ? "#34C759"
                  : "#8E8E93",
              }}
            >
              {status.listings.trueCar.configured
                ? "✓ Configured"
                : "Not configured"}
            </div>
          </div>
          ...
          >
            ...
            <div
              style={{
                fontSize: "16px",
                fontWeight: "600",
                color: status.listings.kbb.configured ? "#34C759" : "#8E8E93",
              }}
            >
              {status.listings.kbb.configured
                ? "✓ Configured"
                : "Not configured"}
            </div>
          </div>
        ...
        >
          ...
          <div
            style={{ fontSize: "24px", fontWeight: "700", color: "#007AFF" }}
          >
        ...
        <p style={{ marginTop: "15px", fontSize: "13px", color: "#666" }}>
          To publish a vehicle, go to Inventory → select vehicle → enable
